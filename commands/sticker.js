...
const sticker = async (client, message, args) => {
...
⸙﹝ Veuillez citer une image ou une vidéo ﹞✴︎
...
> *© AKANE MD 🌹*` });
        ...
        // Fichiers temporaires uniques pour éviter les conflits
        ...
        await client.sendMessage(jid, { sticker: await stickerMetadata.toBuffer() }, { quoted: message });

    } catch (e) {
        console.error(e);
        await client.sendMessage(jid, { text: "❌ Erreur de création du sticker." });
    } finally {
        // ✅ SUPPRESSION CRITIQUE POUR ÉVITER LE SATURATION DISQUE
