// commands/citation.js

// @cat: histoire et citation

// Citations inspirantes - Style simple
...
const quotes = [
    ...
    { text: "Ce que l'on sait, savoir qu'on le sait ; ce que l'on ne sait pas, savoir qu'on ne le sait pas : c'est savoir véritablely.", author: "Confucius" },
...
async function citationCommand(client, message, args) {
...
> *DEV : 🍁AKANE KUROGAWA🌹*`;
    ...
    try {
        ...
        try {
            ...
            console.log('API quote indisponible');
...
> *DEV : 🍁AKANE KUROGAWA🌹*`;
        ...
        await client.sendMessage(remoteJid, { text: fallbackText });
