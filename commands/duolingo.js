...
export async function handleDuoResponse(client, message, messageBody) {
    ...
    // Vérifier si c'est une réponse à un match
...
> *DEV : AKANE KUROGAWA🌹*` });
    ...
    // Vérifier si c'est une réponse à une leçon normale
...
> *DEV : AKANE KUROGAWA🌹*`;
        ...
        // Proposer une nouvelle leçon si l'utilisateur a encore des cœurs
